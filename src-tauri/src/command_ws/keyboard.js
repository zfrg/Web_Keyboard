...
let control_panel_list = [
    ...
    { "ScreenStream": { type: "other", value: `<svg style="width: 1.2rem;height: 1.2rem;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M810.666667 682.666667a42.666667 42.666667 0 0 0 42.368-37.674667L853.333333 640V213.333333a42.666667 42.666667 0 0 0-37.674666-42.368L810.666667 170.666667H213.333333a42.666667 42.666667 0 0 0-42.368 37.674666L170.666667 213.333333v426.666667a42.666667 42.666667 0 0 0 37.674666 42.368L213.333333 682.666667h213.333334a42.666667 42.666667 0 0 1 0 85.333333H213.333333a128 128 0 0 1-128-128V213.333333a128 128 0 0 1 128-128h597.333334a128 128 0 0 1 128 128v426.666667a128 128 0 0 1-128 128h-213.333334a42.666667 42.666667 0 0 1 0-85.333333h213.333334zM341.333333 853.333333h341.333334a42.666667 42.666667 0 0 1 0 85.333334H341.333333a42.666667 42.666667 0 0 1 0-85.333334z" fill="#8a94a4"></path><path d="M514.858667 256c10.197333 0.426667 20.266667 4.394667 28.288 11.904l100.778666 94.293333a41.216 41.216 0 0 1 0.981334 59.264 44.074667 44.074667 0 0 1-61.226667 1.024l-29.184-27.306666v159.914666a42.624 42.624 0 0 1-84.949333 4.992l-0.298667-4.992V395.264l-29.013333 27.221333c-17.408 16.213333-44.501333 15.786667-61.312-1.024a41.216 41.216 0 0 1 0.981333-59.264l100.821333-94.293333A43.946667 43.946667 0 0 1 511.957333 256z" fill="#8a94a4"></path></svg>` } },
...
function keydown_fn(event) {
    ...
    if (OpenObj[key]) {
        if (key === 'ScreenStream') return ScreenStreamFn()
        return window.open(OpenObj[key])
    }
...
function ScreenStreamFn() {
    window.open('/screen_stream')
}
